...
#SBATCH --error=/home/dbelivan/research/run_N_steps_100_50_w_bound_ratio_2_1.err
#SBATCH --output=/home/dbelivan/research/run_N_steps_100_50_w_bound_ratio_2_1.out
#
#
echo "start script"
