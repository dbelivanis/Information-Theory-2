...
using Plots
    ...
    function Info_upscale(tf_variables,model_param,q_t_x,q_t_y,N_k_dis_,maxiter=400)
        ...
        loss_x = loss_x_list[5][1] + loss_x_list[4][1] + loss_x_list[6][1] 
        loss_y = loss_y_list[5][1] + loss_y_list[4][1] + loss_y_list[6][1] 
        loss = loss_x + loss_y 
        
        # Loss function as Mean Square Error
        dw_x = loss_x_list[5][2] + loss_x_list[4][2] + loss_x_list[6][2] 
        dw_y = loss_y_list[5][2] + loss_x_list[4][2] + loss_y_list[6][2]         
