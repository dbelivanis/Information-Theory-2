...
function solver_multi_k(model_param)
    ...
    K_array = reshape(K_array, (model_param.N_k, model_param.N_x, model_param.N_y))
    ...
    K_log = ones(model_param.N_k, model_param.N_x, model_param.N_y) .* K_log_mean + K_array .* K_log_var
