...
module param()
    ...
    function Multi_point_flux_aux_matrix(param)
        ...
        vv_l = [1. for i in 1:param.N_x:param.Ne]
        # B
        ...
        vv_r = [1. for i in 1:param.N_x:param.Ne]
    ...
    function load_QoIs(model_param)
        ...
        y_x_list = [readdlm(files_x[ii], ' ', Float64)/1000 for ii =1:9];
        y_y_list = [readdlm(files_y[ii], ' ', Float64)/1000 for ii =1:9];
