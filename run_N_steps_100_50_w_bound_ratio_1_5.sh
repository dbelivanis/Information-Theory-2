...
#SBATCH --error=/home/dbelivan/research/run_N_steps_100_50_w_bound_ratio_1_5.err
#SBATCH --output=/home/dbelivan/research/run_N_steps_100_50_w_bound_ratio_1_5.out
#
#
echo "start script"
