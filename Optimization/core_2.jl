...
loss, dw_2, opt_ADAM, opt_LFGS, opt_ADAM_sum, opt_LFGS_sum, diff_eval,p_pre_soft_max, p = Info_upscale(tf_variables,param_model_val,q_t_x,q_t_y,maxiter,N_k_dis_)
...
print_status(sess,loss,diff_eval,T_exp,T_,N_k_dis_,tf_variables,"w")
