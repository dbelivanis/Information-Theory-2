...
#SBATCH --error=/data/cees/dbelivan/check_core_1000_N_steps_200.err
#SBATCH --output=/data/cees/dbelivan/check_core_1000_N_steps_200.out
#
#
echo "start script"
...
/home/dbelivan/julia-1.5.3/bin/julia core.jl 1000 200
#
